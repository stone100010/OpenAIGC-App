...
CREATE INDEX IF NOT EXISTS idx_user_artworks_user_id ON user_artworks(user_id);
CREATE INDEX IF NOT EXISTS idx_user_artworks_content_type ON user_artworks(content_type);
CREATE INDEX IF NOT EXISTS idx_user_artworks_created_at ON user_artworks(created_at);
CREATE INDEX IF NOT EXISTS idx_user_artworks_is_public ON user_artworks(is_public);
...
CREATE TRIGGER IF NOT EXISTS update_user_artworks_updated_at 
...
CREATE TRIGGER IF NOT EXISTS trigger_update_user_artworks_count
...
-- 为用户注册添加邀请码核销触发器
CREATE TRIGGER IF NOT EXISTS trigger_invite_code_consumption
